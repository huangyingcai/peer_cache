...
# Generated by qmake (2.01a) (Qt 4.7.4) on: Sat Dec 1 13:13:38 2012
...
server.o: server.cc 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o server.o server.cc

resource_manager.o: resource_manager.cc 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o resource_manager.o resource_manager.cc
